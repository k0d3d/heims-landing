...
export default function Home() {
  return (
    <div className="container">
      <Head>
        <title>Heims: View Demo for Headless Inventory Manager </title>
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <main>
        <h1 className="title">
          Headless Inventory Manager (Heims)
        </h1>

        <p className="description">
          BYFE. Bring your front-end.  Get started by managing your Inventory with an easy RESTful API
        </p>
